...
cy_stc_smif_mem_cmd_t LFS_SFDP_SlaveSlot_0_readCmd =
{
...
cy_stc_smif_mem_cmd_t LFS_SFDP_SlaveSlot_0_writeEnCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_cmd_t LFS_SFDP_SlaveSlot_0_writeDisCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_cmd_t LFS_SFDP_SlaveSlot_0_eraseCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_cmd_t LFS_SFDP_SlaveSlot_0_chipEraseCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_cmd_t LFS_SFDP_SlaveSlot_0_programCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_cmd_t LFS_SFDP_SlaveSlot_0_readStsRegQeCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_cmd_t LFS_SFDP_SlaveSlot_0_readStsRegWipCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_cmd_t LFS_SFDP_SlaveSlot_0_writeStsRegQeCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_cmd_t LFS_SFDP_SlaveSlot_0_readSfdpCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x5AU,
    /* The width of the command transfer. */
...
cy_stc_smif_hybrid_region_info_t LFS_SFDP_SlaveSlot_0_regionInfoStorage[16];

cy_stc_smif_hybrid_region_info_t *LFS_SFDP_SlaveSlot_0_regionInfo[16] = {
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[0],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[1],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[2],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[3],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[4],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[5],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[6],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[7],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[8],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[9],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[10],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[11],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[12],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[13],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[14],
    &LFS_SFDP_SlaveSlot_0_regionInfoStorage[15]
};
#endif

cy_stc_smif_mem_device_cfg_t LFS_DeviceCfg_SFDP_SlaveSlot_0 =
{
    ...
    .readCmd = &LFS_SFDP_SlaveSlot_0_readCmd,
    /* Specifies the Write Enable command. */
    .writeEnCmd = &LFS_SFDP_SlaveSlot_0_writeEnCmd,
    /* Specifies the Write Disable command. */
    .writeDisCmd = &LFS_SFDP_SlaveSlot_0_writeDisCmd,
    /* Specifies the Erase command. */
    .eraseCmd = &LFS_SFDP_SlaveSlot_0_eraseCmd,
    /* Specifies the sector size of each erase. */
    .eraseSize = 0x0001000U,
    /* Specifies the Chip Erase command. */
    .chipEraseCmd = &LFS_SFDP_SlaveSlot_0_chipEraseCmd,
    /* Specifies the Program command. */
    .programCmd = &LFS_SFDP_SlaveSlot_0_programCmd,
    ...
    .readStsRegQeCmd = &LFS_SFDP_SlaveSlot_0_readStsRegQeCmd,
    /* Specifies the command to read the WIP-containing status register. */
    .readStsRegWipCmd = &LFS_SFDP_SlaveSlot_0_readStsRegWipCmd,
    /* Specifies the read SFDP command */
    .readSfdpCmd = &LFS_SFDP_SlaveSlot_0_readSfdpCmd,
    /* Specifies the command to write into the QE-containing status register. */
    .writeStsRegQeCmd = &LFS_SFDP_SlaveSlot_0_writeStsRegQeCmd,
    ...
    .hybridRegionInfo = LFS_SFDP_SlaveSlot_0_regionInfo
#endif
};

cy_stc_smif_mem_config_t LFS_SFDP_SlaveSlot_0 =
{
    /* Determines the slot number where the memory device is placed. */
    .slaveSelect = CY_SMIF_SLAVE_SELECT_0,
    /* Flags. */
#if (CY_IP_MXSMIF_VERSION >= 2)
    .flags = CY_SMIF_FLAG_SMIF_REV_3 | CY_SMIF_FLAG_MEMORY_MAPPED | CY_SMIF_FLAG_WR_EN | CY_SMIF_FLAG_DETECT_SFDP,
#else
...
const cy_stc_smif_mem_config_t* const LFS_SmifMemConfigsSfdp[] = {
   &LFS_SFDP_SlaveSlot_0
};

const cy_stc_smif_block_config_t LFS_SmifBlockConfig =
{
    /* The number of SMIF memories defined. */
    .memCount = CY_SMIF_DEVICE_NUM,
    /* The pointer to the array of memory config structures of size memCount. */
    .memConfig = (cy_stc_smif_mem_config_t**)LFS_SmifMemConfigsSfdp,
